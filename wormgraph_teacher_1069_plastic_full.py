...
# from distill_wormgraph_to_zkagi import WormGraphTeacher, ZkAGIConfig  # Importa o teacher real
# Mock the WormGraphTeacher to make this runnable
class ZkAGIConfig:
...
class WormGraphTeacher(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
        self.domains = ["domain1", "domain2", "domain3"]
