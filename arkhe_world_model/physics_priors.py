...
class PhysicsPriorsModule(nn.Module):
    ...
    def __init__(
        ...
        # Projeção final
        # Note: state_dim // n_priors * n_priors is not necessarily state_dim
        # So we use the actual combined dimension
        actual_prior_stack_dim = (state_dim // n_priors) * n_priors
        self.output_proj = nn.Sequential(
            nn.Linear(actual_prior_stack_dim, state_dim),
