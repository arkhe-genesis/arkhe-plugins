...
from Cathedral.v17.config_loader import CathedralConfig
from Cathedral.v17.fast_brain import FastBrain, VisionModule, WorldModelRSSM, SafetyEngineZ3, EpisodicMemoryHNSW, MetaLearningModule
...
async def benchmark_slow_brain():
    ...
    config = CathedralConfig()
    from Cathedral.v17.slow_brain import SlowBrainSGLang
...
def benchmark_router():
    ...
    config = CathedralConfig()
    from Cathedral.v17.orchestrator_v17 import Router
    from Cathedral.v17.fast_brain import FastBrainState
...
def print_hardware_info():
    ...
    try:
        ...
        print("  GPU: N/A (PyTorch não disponível)")
    ...
    try:
        ...
        print("  RAM/CPU: N/A (psutil não disponível)")
    print()
