...
class ScanningDNADecoder:
    ...
    def __init__(self):
        ...
        self.primer_mapping: Dict[str, str] = {} # struct_tag -> column_name
    ...
    def register_primer(self, struct_tag: str, column_name: str) -> str:
        ...
        self.primer_mapping[struct_tag] = column_name
        return primer
    ...
    def decode_row(self, row_data: Dict, struct_fields: List[str]) -> Dict:
        ...
        for field in struct_fields:
            ...
            tag = f"drop:{field}"
            mapped_col = self.primer_mapping.get(tag)

            if mapped_col and mapped_col in row_data:
                decoded[field] = row_data[mapped_col]
                matched_primers += 1
